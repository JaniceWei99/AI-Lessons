...
- **课程维护指南** (`docs/maintenance-guide.md`) — 面向维护人员的详细操作手册，涵盖：
  - 三种操作场景：修改课程内容、新增一课、删减一课
  - 每种场景的影响文件清单和详细步骤
  - HTML 编写规范和双语系统规则
  - 全部 9 种可用组件的 HTML 模板（卡片网格、对比区块、时间线、选择题、AI 鉴别、信息框、步骤列表、可展开卡片、代码块）
  - 版本首页编辑方法、导航链接规则、讲稿编辑指南
  - 修改后的完整验证清单
  - 提交与发布流程

### 修改 (Changed)

- `README.md` 文档表格中添加维护指南链接
