...
> 面向 10-16 岁青少年的人工智能入门课程，五大版本共 52 课时，网页形式交付。**支持中英双语切换。**
...
> **注**: standard-5/standard-15 主要面向 13-15 岁初中生；lab-10 面向 11-15 岁；app-inventor-10 面向 10-14 岁；web-ai-12 面向 12-16 岁。
...
*文档版本：v1.3.0 | 已确认（含双语支持 + 测验增强 + 五版本架构），开始实施*
